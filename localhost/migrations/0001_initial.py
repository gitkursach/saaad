# Generated by Django 3.2.7 on 2022-01-11 21:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('images', models.FileField(upload_to='users_photo/%Y/%m/%d/', validators=[localhost.models.file_size_img, django.core.validators.FileExtensionValidator(['jpeg', 'png', 'bmp', 'gif'], message='Ваше изображение должен быть jpeg, png, bmp, gif')])),
